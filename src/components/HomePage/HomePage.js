      ...
      <section className="pb-10 bg-gray-800">
        <div className="relative container px-4   mx-auto">
          <div className="flex flex-wrap items-center -mx-4 mb-10 2xl:mb-14">
            ...
            <h1 className="max-w-2xl mt-12 mb-12 text-8xl 2xl:text-8xl text-white font-bold font-heading">
                Acquaintance{" "}
              </h1>
              <span className="text-lg font-bold text-blue-400">
                Open yourself to the new world
              </span>
              <h6 className="max-w-2xl mt-12 mb-12 text-5xl 3xl:text-8xl text-white font-bold font-heading">
